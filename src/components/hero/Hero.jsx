      ...
      <div className={styles.Hero__contain}>
        <div className={styles.Hero__infoContain}>
          <div className={styles.Hero__info}>
            <h3>👋 Hi, i'm Andy</h3>
            <p>
              Hello, I'm a Front-End developer passionate about crafting
              engaging and user-friendly web experiences. I'm dedicated to
              continually improving my skills and knowledge in the world of web
              development.
            </p>
          </div>
